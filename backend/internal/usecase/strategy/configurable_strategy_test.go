	...
	return []indicatorScenario{
		{
			...
			indicators: entity.IndicatorSet{
				SymbolID:    7,
				SMAShort:       fpRef(5_100_000),
				SMALong:       fpRef(5_000_000),
				EMAFast:       fpRef(5_100_000),
				EMASlow:       fpRef(5_000_000),
				RSI:       fpRef(55),
				Histogram:   fpRef(5),
		...
		},
		{
			...
			indicators: entity.IndicatorSet{
				SymbolID:      7,
				SMAShort:         fpRef(5_050_000),
				SMALong:         fpRef(5_000_000),
				EMAFast:         fpRef(5_050_000),
				EMASlow:         fpRef(5_000_000),
				RSI:         fpRef(55), // neutral: avoids CONTRARIAN override
